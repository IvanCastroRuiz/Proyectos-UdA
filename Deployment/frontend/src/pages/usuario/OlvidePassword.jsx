    ...
    return (
        <div className='flex w-full'>
            <div className='flex flex-col justify-center items-center lg:w-2/4 mr-10 md:flex-row '>
                ...
                <div>
                    <h1 className='font-bold text-6xl uppercase text-center md:w-2/3 mx-auto'>Recupera tu cuenta y disfruta de los <span className='text-sky-700'>productos</span></h1><form className='p-4 mx-auto w-96 sm:px-9 mt-8 shadow-md'>
                        <div className='mb-5'>
                        ...
                        <input type="submit" value="Enviar" className='uppercase bg-sky-700 text-white p-2 rounded-md w-full' />
